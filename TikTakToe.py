...
class Game(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.geometry("250x350+50+50")
        self.title('TikTakToe')
        self.resizable(False, False)

        self.camvas = tk.Canvas(self, width=230, height=215)
